...
public class FAST {
	...
	public static FASTReaderReactor inputReactor(FASTInput fastInput, byte[] catBytes, PipeBundle ringBuffers) {
	...
	public static FASTReaderReactor inputReactor(int bufferSize, FASTInput fastInput, byte[] catBytes, PipeBundle ringBuffers) {
	    FASTDecoder readerDispatch = DispatchLoader.loadDispatchReader(catBytes, ringBuffers); 
	    PrimitiveReader reader = new PrimitiveReader(bufferSize, fastInput, readerDispatch.maxPMapCountInBytes);
	    return new FASTReaderReactor(readerDispatch,reader);
	}
	
	public static FASTReaderReactor inputReactorDebug(FASTInput fastInput, byte[] catBytes, PipeBundle ringBuffers) {
	    FASTDecoder readerDispatch = DispatchLoader.loadDispatchReaderDebug(catBytes, ringBuffers); 
	    PrimitiveReader reader = new PrimitiveReader(DEFAULT_BUFFER_SIZE, fastInput, readerDispatch.maxPMapCountInBytes);
	    return new FASTReaderReactor(readerDispatch,reader);
	}
	
	public static FASTReaderReactor inputReactorDebug(int bufferSize, FASTInput fastInput, byte[] catBytes, PipeBundle ringBuffers) {
	    FASTDecoder readerDispatch = DispatchLoader.loadDispatchReaderDebug(catBytes, ringBuffers); 
	    PrimitiveReader reader = new PrimitiveReader(bufferSize, fastInput, readerDispatch.maxPMapCountInBytes);
	    return new FASTReaderReactor(readerDispatch,reader);
	}
